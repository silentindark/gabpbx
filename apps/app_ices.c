...
/*! \file
 *
 * \brief Stream to an icecast server via ICES (see contrib/gabpbx-ices.xml)
 *
...
/*** DOCUMENTATION
	<application name="ICES" language="en_US">
		...
		<description>
			...
			A configuration file must be supplied for ices (see contrib/gabpbx-ices.xml).</para>
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Encode and Stream via icecast and ices");
