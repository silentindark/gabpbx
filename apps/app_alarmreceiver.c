...
/*
* This is the main function called by GABpbx Core whenever the App is invoked in the extension logic.
...
/*
* These functions are required to implement an GABpbx App.
*/
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Alarm Receiver for GABpbx");
