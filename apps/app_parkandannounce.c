...
/*! \file
 *
 * \brief ParkAndAnnounce application for GABpbx
 *
 * \author Ben Miller <bgmiller@dccinc.com>
...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 354495 $")
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Call Parking and Announce Application");
