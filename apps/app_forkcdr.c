...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 362082 $")
...
/*** DOCUMENTATION
	<application name="ForkCDR" language="en_US">
		...
		<description>
			...
			will be affected by events transpiring within GABpbx, with the previously noted exceptions.</para>
		</description>
		<see-also>
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Fork The CDR into 2 separate entities");
