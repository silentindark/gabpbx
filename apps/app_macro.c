...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 338084 $")
...
/*** DOCUMENTATION
	<application name="Macro" language="en_US">
		...
		<description>
			...
			applications in deeply nested macros could cause gabpbx to crash earlier than this limit.
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Extension Macros");
