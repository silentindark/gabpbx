...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 338609 $")
...
#define OSP_AST_OK				((int)0)					/* GABpbx function call successful */
#define OSP_AST_ERROR			((int)-1)					/* GABpbx function call error */
...
struct osp_results {
	...
	char tech[OSP_SIZE_TECHSTR];						/* Outbound GABpbx TECH string */
...
/*!
 * \brief Convert GABpbx status to TC code
 * \param cause GABpbx hangup cause
 * \return OSP TC code
 */
static OSPEFAILREASON gabpbx2osp(
	int cause)
{
 ...
 * \param cause GABpbx hangup cuase
...
AST_MODULE_INFO(GABPBX_GPL_KEY, AST_MODFLAG_DEFAULT, "Open Settlement Protocol Applications",
	.load = load_module,
