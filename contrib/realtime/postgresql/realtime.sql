...
ALTER TABLE queue_table OWNER TO gabpbx;
...
GRANT ALL ON TABLE cdr TO gabpbx;
GRANT ALL ON TABLE extensions_conf TO gabpbx;
GRANT ALL ON TABLE sip_conf TO gabpbx;
GRANT ALL ON TABLE voicemail_users TO gabpbx;
GRANT ALL ON TABLE queue_member_table TO gabpbx;
GRANT ALL ON TABLE queue_table TO gabpbx;
