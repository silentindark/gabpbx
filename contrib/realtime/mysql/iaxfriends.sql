...
CREATE TABLE `iaxfriends` (
  ...
  `ipaddr` varchar(40) NULL, -- Must be updateable by GABpbx user
  `port` int(5) NULL, -- Must be updateable by GABpbx user
  `defaultip` varchar(20) NULL,
  `sourceaddress` varchar(20) NULL,
  `mask` varchar(20) NULL,
  `regexten` varchar(40) NULL,
  `regseconds` int(11) NULL, -- Must be updateable by GABpbx user
