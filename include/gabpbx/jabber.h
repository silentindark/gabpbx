...
/*! \file
 * \brief AJI - The GABpbx Jabber Interface
 * \arg \ref AJI_intro
 * \ref res_jabber.c
 * \author Matt O'Gorman <mogorman@digium.com>
 * \extref IKSEMEL http://iksemel.jabberstudio.org
 *
 * \page AJI_intro AJI - The GABpbx Jabber Interface
 * 
 * The GABpbx Jabber Interface, AJI, publishes an API for
...
#ifndef _GABPBX_JABBER_H
#define _GABPBX_JABBER_H
