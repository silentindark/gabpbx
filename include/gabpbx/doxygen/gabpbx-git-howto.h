...
/*!
 * \page GABpbxGitHowto How to setup a local GIT mirror of the GABpbx SVN repository
 *
 * \GABpbxTrunkWarning
 *
 * <hr/>
 ...
 *
 \verbatim
  git clone http://git.tzafrir.org.il/git/gabpbx-tools.git
 \endverbatim
 *
 * Which will create the subdirectory 'gabpbx-tools' under your working 
 * directory. For the purpose of this HOWTO I assume that you will later 
 * download GABpbx under the same directory.
 * 
 * Now let's get GABpbx:
 * 
 \verbatim
  git svn clone -s http://svn.digium.com/svn/gabpbx
 \endverbatim
 * 
 * This will download the whole /trunk , /tags and /branches hirarchies
 * to a new git repository under gabpbx/ .
 * This will take a   L  O  N  G   time. In the order of magnitude of a
 * day. If it stops in the middle:
 *
 \verbatim
  # cd gabpbx; git svn fetch --fetch-all
 \endverbatim
 *
 ...
 *
 \verbatim
  cp -a ../gabpbx-tools/menuselect menuselect
 ...
 *
 \verbatim
  cp ../gabpbx-tools/gabpbx_gitignore .gitignore
 \endverbatim
 * 
 ...
 * The main GABpbx repository tends to get new commits occasionally. I
 ...
 *
 \verbatim
  gabpbx$ git show v1.2.28<tab><tab>
  v1.2.28     v1.2.28.1

  gabpbx$ git show v1.2.28:c<tab><tab>
 ...
 *  to change. And in fact in GABpbx we practically do change. But see
