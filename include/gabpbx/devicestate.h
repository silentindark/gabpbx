 ...
 * \param fmt device name like a dial string with format parameters
 *
 * GABpbx polls the new extension states and calls the registered
 ...
 *
 * \details
 * By default, GABpbx assumes that device state change events will only be
 * originating from one instance.  If a module gets loaded and configured such
 * that multiple instances of GABpbx will be sharing device state, this
