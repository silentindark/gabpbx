...
#ifndef GABPBX_DATA_H
#define GABPBX_DATA_H

#include "gabpbx/frame.h"

/*!
 * \page AstDataRetrieval The GABpbx DATA retrieval API.
 *
 * This module implements an abstraction for retrieving gabpbx data and
 * export it.
 *
 * \section USAGE
 *
 ...
 *		.path = "/gabpbx/application/app_queue/queues",
...
/*!
 * \brief Retrieve a subtree from the gabpbx data API.
...
#ifdef HAVE_LIBXML2
/*!
 * \brief Retrieve a subtree from the gabpbx data API in XML format..
 * \param[in] query The query structure specifying what nodes to retrieve.
 * \retval NULL on error.
 * \retval non-NULL The dynamically allocated requested sub-tree (it needs to be
 *         released using ast_data_free.
