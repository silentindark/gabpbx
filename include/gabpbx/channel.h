...
#define ast_channel_alloc_remote_uniqueid(needqueue, state, cid_num, cid_name, acctcode, exten, context, linkedid, amaflag, remote_uniqueid, ...) \
        __ast_channel_alloc_remote_uniqueid(needqueue, state, cid_num, cid_name, acctcode, exten, context, linkedid, amaflag, remote_uniqueid, \
                            __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
...
/*! \return non-zero if GABpbx is being shut down */
