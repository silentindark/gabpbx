...
multiple times on the same object, commonly fatal to gabpbx.
...
before the #include "gabpbx/astobj2.h" line, and add a descriptive
tag to each call. Recompile, and run GABpbx, exit gabpbx with
