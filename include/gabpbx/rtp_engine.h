 ...
 *
 * \param gabpbx_format True if the value in the 'code' parameter is an AST_FORMAT value
 ...
 *
 * \param codecs Codecs structure to look in
 * \param astformats An integer to put the GABpbx formats in
...
/*!
 * \brief Retrieve a payload based on whether it is an GABpbx format and the code
 *
 * \param codecs Codecs structure to look in
 * \param gabpbx_format Non-zero if the given code is an GABpbx format value
 ...
 * \param gabpbx_format Non-zero if the given capability are GABpbx format capabilities
 * \param options Additional options that may change the result
 *
 * \retval non-NULL success
 * \retval NULL failure
