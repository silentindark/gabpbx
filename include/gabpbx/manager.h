...
\endverbatim
 ...
 \note Please try to \b re-use \b existing \b headers to simplify manager message parsing in clients.
    ...
    You can find a reference of standard headers in http://wiki.gabpbx.org
...
/*! \brief Called by GABpbx initialization */
int init_manager(void);

/*! \brief Called by GABpbx module functions and the CLI command */
