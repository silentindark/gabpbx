 ...
 * that is in include/gabpbx/doxygen/.
 */
 ...
 * \arg \ref ReleaseStatus : The current support level for various GABpbx releases
 * \arg \ref ReleasePolicies : GABpbx Release and Commit Policies
 * \arg \ref Reviewboard : Reviewboard Usage and Guidelines
 * \arg \ref MantisWorkflow : Workflow Guidelines for GABpbx Open Source Issue Tracker
 * \arg \ref GABpbxGitHowto : How to setup a local GIT mirror of the GABpbx SVN repository
 ...
 * \arg \ref AJI_intro : The GABpbx Jabber Interface
 * \arg \ref AstCDR
 * \arg \ref AstVar
 * \arg \ref AstVideo
 ...
 * \arg \b Main:  GABpbx Developer's website http://www.gabpbx.org/developers/
 * \arg \b Bugs: The Issue Tracker https://issues.gabpbx.org
 * \arg \b Lists: List Server http://lists.digium.com
 * \arg \b Wiki: The GABpbx Wiki 	http://www.voip-info.org
 * \arg \b Docs: The GABpbx Documentation Project http://www.gabpbxdocs.org
 * \arg \b Digium: The GABpbx Company http://www.digium.com
 */
 ...
 * \arg \link Config_ast gabpbx.conf - the main configuration file \endlink
...
/*! 
 * \page Config_ast GABpbx.conf
 * \verbinclude gabpbx-conf.txt
 */
 ...
 * This is the configuration of the H.323 channel driver within the GABpbx
 * distribution. There's another one, called OH323, in gabpbx-addons
 ...
 * \section codec_generic GABpbx Format drivers
