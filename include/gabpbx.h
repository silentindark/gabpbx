 ...
 * GABPBX_FILE_VERSION macro should be used to register a file with the core.
 */
 ...
 *
 * This function should not be called directly, but instead the
 * GABPBX_FILE_VERSION macro should be used to automatically unregister
 ...
 * to registered with the GABpbx core (and unregistered) at the appropriate
 * times.
 *
 * Example:
 *
...
#define GABPBX_FILE_VERSION(file, version) \
...
#endif /* !MTX_PROFILE */
#else /* LOW_MEMORY */
#define GABPBX_FILE_VERSION(file, x)
#endif /* LOW_MEMORY */
