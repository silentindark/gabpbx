...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 380572 $")
...
static const struct ast_data_entry dahdi_data_providers[] = {
	AST_DATA_ENTRY("gabpbx/channel/dahdi/status", &dahdi_status_data_provider),
	AST_DATA_ENTRY("gabpbx/channel/dahdi/channels", &dahdi_channels_data_provider),
	AST_DATA_ENTRY("gabpbx/channel/dahdi/version", &dahdi_version_data_provider)
};
