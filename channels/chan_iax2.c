...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 382233 $")
...
#include "gabpbx/paths.h"	/* need ast_config_AST_DATA_DIR for firmware */
...
/*! \brief Send manager event at call setup to link between GABpbx channel name
...
AST_TEST_DEFINE(test_iax2_peers_get)
{
	struct ast_data_query query = {
		.path = "/gabpbx/channel/iax2/peers",
...
{
	struct ast_data_query query = {
		.path = "/gabpbx/channel/iax2/users",
...
static const struct ast_data_entry iax2_data_providers[] = {
	AST_DATA_ENTRY("gabpbx/channel/iax2/peers", &peers_data_provider),
	AST_DATA_ENTRY("gabpbx/channel/iax2/users", &users_data_provider),
};
