...
static const struct misdn_cfg_spec port_spec[] = {
	...
	{ "dialplan", MISDN_CFG_DIALPLAN, MISDN_CTYPE_INT, "0", NONE,
		...
		"\t      (if -1 is set use the value from the gabpbx channel)\n"
	...
	{ "astdtmf", MISDN_CFG_ASTDTMF, MISDN_CTYPE_BOOL, "no", NONE,
		"Enable this if you want to use the GABpbx dtmf detector\n"
	...
	{ "l1watcher_timeout", MISDN_CFG_L1_TIMEOUT, MISDN_CTYPE_BOOLINT, "0", 4,
		...
		"\tvalue.  An gabpbx restart will also do the trick." },
	...
	{ "msns", MISDN_CFG_MSNS, MISDN_CTYPE_MSNLIST, "*", NONE,
		...
		"\tindicate the incoming calls to GABpbx.\n"
...
#endif
	{ "tracefile", MISDN_GEN_TRACEFILE, MISDN_CTYPE_STR, "/var/log/gabpbx/misdn.log", NONE,
