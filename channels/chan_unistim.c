...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 362485 $")
...
/*! Beware, G729 and G723 are not supported by gabpbx, except with the proper licence */
...
struct unistim_subchannel {
	...
	/*! GABpbx channel used by the subchannel */
