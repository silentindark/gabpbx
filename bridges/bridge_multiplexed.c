...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 361403 $")
...
#include "gabpbx/bridging_technology.h"
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "Multiplexed two channel bridging module");
