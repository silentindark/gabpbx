 ...
 * internal binary format of events between GABpbx servers over a network.
...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 359053 $");
...
AST_MODULE_INFO_STANDARD(GABPBX_GPL_KEY, "SAForum AIS");
