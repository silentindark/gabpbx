...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 413586 $")
...
/*** DOCUMENTATION
	<application name="Monitor" language="en_US">
		...
		<description>
			...
			<para>By default, files are stored to <filename>/var/spool/gabpbx/monitor/</filename>.
 ...
 * The file format extensions that GABpbx uses are not all the same as that
...
AST_MODULE_INFO(GABPBX_GPL_KEY, AST_MODFLAG_GLOBAL_SYMBOLS | AST_MODFLAG_LOAD_ORDER, "Call Monitoring Resource",
		.load = load_module,
