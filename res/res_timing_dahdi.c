...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 375893 $");
...
#define SEE_TIMING "For more information on GABpbx timing modules, including ways to potentially fix this problem, please see https://wiki.gabpbx.org/wiki/display/AST/Timing+Interfaces\n"
