...
struct {
	/*! \brief The gabpbx data main content structure. */
	struct ao2_container *container;
	/*! \brief gabpbx data locking mechanism. */
	ast_rwlock_t lock;
} root_data;
...
/*!
 * \internal
 * \brief Create the middle nodes for the specified path (gabpbx/testnode1/childnode)
