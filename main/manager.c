...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 372058 $")
...
/*** DOCUMENTATION
	...
	<manager name="UpdateConfig" language="en_US">
		...
		<description>
			...
			in GABpbx configuration files.</para>
		</description>
	</manager>
	...
	<manager name="Command" language="en_US">
		<synopsis>
			Execute GABpbx CLI Command.
		</synopsis>
		<syntax>
			<xi:include xpointer="xpointer(/docs/manager[@name='Login']/syntax/parameter[@name='ActionID'])" />
			<parameter name="Command" required="true">
				<para>GABpbx CLI command to run.</para>
			</parameter>
		</syntax>
		<description>
	...
	<manager name="ModuleLoad" language="en_US">
		...
		<syntax>
			<xi:include xpointer="xpointer(/docs/manager[@name='Login']/syntax/parameter[@name='ActionID'])" />
			<parameter name="Module">
				<para>GABpbx module name (including .so extension) or subsystem identifier:</para>
				<enumlist>
					<enum name="cdr" />
					<enum name="enum" />
					<enum name="dnsmgr" />
		...
		<description>
			<para>Loads, unloads or reloads an GABpbx module in a running system.</para>
		</description>
	</manager>
	<manager name="ModuleCheck" language="en_US">
		...
		<syntax>
			<parameter name="Module" required="true">
				<para>GABpbx module name (not including extension).</para>
			</parameter>
		</syntax>
		<description>
			<para>Checks if GABpbx module is loaded. Will return Success/Failure.
 ...
 * 'mansession' struct is named this solely to keep the API the same in GABpbx. This structure really
...
static int __init_manager(int reload)
{
	...
	if (!cfg || cfg == CONFIG_STATUS_FILEINVALID) {
		ast_log(LOG_NOTICE, "Unable to open AMI configuration manager.conf, or configuration is invalid. GABpbx management interface (AMI) disabled.\n");
		return 0;
	}
