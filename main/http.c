...
GABPBX_FILE_VERSION(__FILE__, "$Revision: 366650 $")
	...
	struct ast_variable *headers)
{
	...
	/* Yuck.  I'm not really sold on this, but if you don't deliver static content it makes your configuration
	   substantially more challenging, but this seems like a rather irritating feature creep on GABpbx. */
	...
	struct ast_variable *headers)
{
	...
	ast_str_append(&out, 0,
		"<title>GABpbx HTTP Status</title>\r\n"
		"<body bgcolor=\"#ffffff\">\r\n"
	...
	ast_str_append(&out, 0, "</table><center><font size=\"-1\"><i>GABpbx and Digium are registered trademarks of Digium, Inc.</i></font></center></body>\r\n");
